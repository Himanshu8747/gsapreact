const About = () => {
    return (
      <div className="two flex h-screen bg-[#4d231c]">
        <div className="lft-two flex items-start justify-center flex-col gap-[5vh] w-[50%] h-full">
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="mt-[50vh] w-[90%] rotate-x-[50deg]">
        ...
        <div className="rght-two flex items-start justify-center flex-col gap-[5vh] w-[50%] h-full">
